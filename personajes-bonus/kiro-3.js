/* Kiro · se teletransporta — personaje bonus listo para el juego.
   Uso:  <script src="personajes-bonus/kiro-3.js"></script>
         BONUS.montar('kiro-3', document.querySelector('.hoyo'));
   Se dibuja igual que en la galería: trae su propio CSS y se inyecta una sola vez. */
(function(){
  var ID  = "kiro-3";
  var CSS = "@keyframes bn_kiroFade{0%,100%{opacity:.9;transform:translateX(0)}20%{opacity:0;transform:translateX(-14px)}30%{opacity:0;transform:translateX(14px)}50%{opacity:.9;transform:translateX(0)}70%{opacity:0;transform:translateX(14px)}80%{opacity:0;transform:translateX(-14px)}}.bonus-kiro-3 .p-body{animation:bn_kiroFade 5.2s infinite}";
